...
public:
	...
	// リストを渡す
	void SetEmitters(const std::vector<playerEmitterInfo>& emitters) { m_emitters = emitters; }
...
private:
	...
	static const float SPAWN_Y_OFFSET;				///< 出現場所Yのオフセット
...
private:
	...
	// 座標リスト
	std::vector<playerEmitterInfo> m_emitters;
};
