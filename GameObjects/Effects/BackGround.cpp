...
void BackGround::Create(DX::DeviceResources* pDR)
{
	...
	//	画像の読み込み
	LoadTexture(L"Resources/Textures/background.png");
...
void BackGround::CreateShader()
{
	...
	std::unique_ptr<BinaryFile> VSData = BinaryFile::LoadFile(L"Resources/Shaders/BackGroundVS.cso");
	std::unique_ptr<BinaryFile> GSData = BinaryFile::LoadFile(L"Resources/Shaders/BackGroundGS.cso");
	std::unique_ptr<BinaryFile> PSData = BinaryFile::LoadFile(L"Resources/Shaders/BackGroundPS.cso");
