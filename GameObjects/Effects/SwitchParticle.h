...
public:
	...
	// リストを渡す
	void SetEmitters(const std::vector<SwitchEmitterInfo>& emitters) { m_emitters = emitters; }
private:
	// シェーダー作成部分だけ分離した関数
	void CreateShader();
...
private:
	...
	// 座標リスト
	std::vector<SwitchEmitterInfo> m_emitters;
};
