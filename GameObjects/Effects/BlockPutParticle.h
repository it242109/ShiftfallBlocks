...
// スイッチ情報
struct blockPutEmitterInfo
{
	DirectX::SimpleMath::Vector3 position;
	DirectX::SimpleMath::Vector3 scale;
};

class BlockPutParticle
{
...
public:
	...
	// リストを渡す
	void SetEmitters(const std::vector<blockPutEmitterInfo>& emitters) { m_emitters = emitters; }
...
private:
	...
	// 座標リスト
	std::vector<blockPutEmitterInfo> m_emitters;
