...
public:
        ...
        DirectX::SpriteEffects effects = DirectX::SpriteEffects_None, float layerDepth = 0) const
    {
        ...
        if (frame.rotated)
        {
            ...
            switch (effects)
            {
            case DirectX::SpriteEffects_FlipHorizontally:    effects = DirectX::SpriteEffects_FlipVertically; break;
            case DirectX::SpriteEffects_FlipVertically:      effects = DirectX::SpriteEffects_FlipHorizontally; break;
            default: break;
            }
        }

        DirectX::XMFLOAT2 origin = frame.origin;
        switch (effects)
        {
        case DirectX::SpriteEffects_FlipHorizontally:    origin.x = float(frame.sourceRect.right - frame.sourceRect.left) - origin.x; break;
        case DirectX::SpriteEffects_FlipVertically:      origin.y = float(frame.sourceRect.bottom - frame.sourceRect.top) - origin.y; break;
        default: break;
        }
        ...
        DirectX::SpriteEffects effects = DirectX::SpriteEffects_None, float layerDepth = 0) const
    {
        ...
        DirectX::XMVECTOR vorigin = XMLoadFloat2(&origin);
