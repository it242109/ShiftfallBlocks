...
DX::RenderTexture::RenderTexture(DXGI_FORMAT format) noexcept :
    m_format(format),
    m_width(0),
    m_height(0)
{
...
void DX::RenderTexture::SetDevice(_In_ ID3D11Device* device)
{
...
void DX::RenderTexture::SizeResources(size_t width, size_t height)
{
    ...
    DirectX::SetDebugObjectName(m_renderTarget.Get(), "RenderTexture RT");
    ...
    DirectX::SetDebugObjectName(m_renderTargetView.Get(), "RenderTexture RTV");
    ...
    DirectX::SetDebugObjectName(m_shaderResourceView.Get(), "RenderTexture SRV");
...
void DX::RenderTexture::ReleaseDevice() noexcept
{
...
void DX::RenderTexture::SetWindow(const RECT& output)
{
