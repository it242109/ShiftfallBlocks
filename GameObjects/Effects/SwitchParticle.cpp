...
* @return     なし
*/
const std::vector<D3D11_INPUT_ELEMENT_DESC> SwitchParticle::INPUT_LAYOUT =
{
...
* @return     なし
*/
void SwitchParticle::LoadTexture(const wchar_t* path)
{
	// テクスチャリソースの読み込み
...
* @return     なし
*/
void SwitchParticle::Create(DX::DeviceResources* pDR)
{
	m_pDR = pDR;
	...
	//	画像の読み込み
	LoadTexture(L"Resources/Textures/switchParticle.png");
...
*/
float SwitchParticle::RandomFloat(float min, float max)
{
...
* @return    パーティクルの色
*/
DirectX::SimpleMath::Color SwitchParticle::GetColorFromType(SwitchTargetType type)
{
...
* @return     なし
*/
void SwitchParticle::Update(float elapsedTime)
{
	// 0.1秒ごとに複数のパーティクルを生成
	m_timer += elapsedTime;
	if (m_timer >= 0.1f)
...
* @return     なし
*/
void SwitchParticle::CreateShader()
{
...
* @return     なし
*/
void SwitchParticle::Render(DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj)
{
...
* @return     なし
*/
void SwitchParticle::Billboard(DirectX::SimpleMath::Vector3 target, DirectX::SimpleMath::Vector3 eye, DirectX::SimpleMath::Vector3 up)
{
